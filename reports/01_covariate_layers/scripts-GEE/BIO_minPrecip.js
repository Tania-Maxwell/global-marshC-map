// Script to export Minimum precipitation of driest month from WorldClim BIO variables
//06.09.22
...
var covariateName = 'minPrecip'; // <<-- CHANGE FOR EACH EXPORT for filenaming
...
var minPrecip_exported = ee.Image('users/tlgm2/covariate_global/minPrecip_v0_1');
...
//Map.addLayer(maxTemp.clip(site), climParams, "Maximum temp of warmest month (0.1 scale)");
// Map.addLayer(minPrecip_toreduce.clip(site), climParams, "Original minimum precipitation of driest month (mm)");
 Map.addLayer(minPrecip_exported, climParams, "Exported minimum precipitation of driest month (mm)");
...
var layer_for_boolean0 = minPrecip_exported.abs().add(1).unmask(0);
...
var vars = {
  ...
  generationScript: 'https://code.earthengine.google.com/ff869622aba6ed282d40735c06933ed5',
  ...
  title: 'Minimum precipitation of driest month (mm) extended to 50km [Maxwell Global Tidal Marsh Carbon Covariate Layers v0.1]',
...
Export.image.toAsset({
  image: minPrecip.set(vars), //include variables set above
  description: 'export_'
    .concat(covariateName),
    // .concat('_')
    // .concat(startDate.slice(0,4))
