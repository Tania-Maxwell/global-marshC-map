// Script to export Maximum precipitation of wettest month from WorldClim BIO variables
//31.08.23
...
var covariateName = 'maxPrecip'; // <<-- CHANGE FOR EACH EXPORT for filenaming
...
var maxPrecip_exported = ee.Image('users/tlgm2/covariate_global/maxPrecip_v0_1');
...
Map.addLayer(maxPrecip_exported, climParams, "Exported maximum precipitation of wettest month (mm)");
...
var layer_for_boolean0 = maxPrecip_exported.abs().add(1).unmask(0);
...
var vars = {
  ...
  title: 'Maximum precipitation of wettest month (mm) extended to 50km [Maxwell Global Tidal Marsh Carbon Covariate Layers v0.1]',
...
Export.image.toAsset({
  image: maxPrecip.set(vars), //include variables set above
  description: 'export_'
    .concat(covariateName),
    // .concat('_')
    // .concat(startDate.slice(0,4))
