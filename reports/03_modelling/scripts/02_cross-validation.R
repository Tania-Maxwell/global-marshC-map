...
# output_grid <- args[2]
# output_folds <- args[3]
# output_random <- args[4]
# output_spatial <- args[5]
...
output_random <- "reports/03_modelling/snakesteps/02_CV/random_cv.rds"
output_spatial <- "reports/03_modelling/snakesteps/02_CV/spatial_cv.rds"
...
saveRDS(random_cv, output_random)
saveRDS(spatial_cv, output_spatial)
